...
<div class="row mb-3">
    <div class="col-md-12 text-center">
        <b class="card-title text-dark">Rekapitulasi Log X-Token Api Key</b>
    </div>
</div>
<div class="row">
                ...
                <?php
                    ...
                    if ($periode == "Bulanan") {
                        ...
                        for ($day = 1; $day <= $days_in_month; $day++) {
                            ...
                            $QueryTotal = "SELECT id_api_session FROM api_session WHERE (id_setting_api_key='$id_setting_api_key') AND (datetime_creat LIKE '%$Keyword%')";
                            $ResultTotal = mysqli_query($Conn, $QueryTotal);
                            $JumlahToken = ($ResultTotal) ? mysqli_num_rows($ResultTotal) : 0;
                            echo '<tr>';
                            echo '  <td align="center">'.$no.'</td>';
                            echo '  <td align="left">';
                            echo '      <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#ModalListLogTokenApiKey" data-id="'.$id_setting_api_key.','.$periode.','.$Keyword.'">';
