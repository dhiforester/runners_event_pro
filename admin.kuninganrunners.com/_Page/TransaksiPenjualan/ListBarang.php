...
?>
            <script>
                ...
                $('#NextPageBarang').click(function() {
                    var NextPageBarang=$('#NextPageBarang').val();
                    $('#put_page_barang').val(NextPageBarang);
                    ListBarang();
                });
                //Ketika klik Previous
                $('#PrevPageBarang').click(function() {
                    var PrevPageBarang = $('#PrevPageBarang').val();
                    $('#put_page_barang').val(PrevPageBarang);
                    ListBarang();
                });
                    ...
                    <ol class="list-group list-group-numbered">
                        <?php
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                echo '  </div>';
                                echo '  <a href="javascript:void(0);" class="text text-grayish" data-bs-toggle="modal" data-bs-target="#ModalPilihBarang" data-id="'.$id_barang.'">';
            ...
            <div class="row mb-3">
                <div class="col-md-12 text-center">
                    <div class="btn-group shadow-0" role="group" aria-label="Basic example">
                        <button class="btn btn-sm btn-grayish" id="PrevPageBarang" value="<?php echo $prev;?>">
                            <i class="bi bi-chevron-left"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-grayish">
                            <?php echo "$page of $JmlHalaman"; ?>
                        </button>
                        <button class="btn btn-sm btn-grayish" id="NextPageBarang" value="<?php echo $next;?>">
