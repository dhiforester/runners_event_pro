                    ...
                    payButton.addEventListener('click', function () {
                        ...
                        window.snap.pay('<?php echo $snap_token;?>', {
                            ...
                            onPending: function(result){
                                ...
                                $('#ModalTambahPembayaran').modal('hide');
                                $('#pay-button').html('<i class="bi bi-arrow-right-circle"></i> Lanjutkan');
                                Swal.fire('Menunggu', 'Pembayaran Masih Dalam Proses!', 'warning');
                            },
                            onError: function(result){
                                /* You may add your own implementation here */
                                ShowPembayaran(GetKodeTransaksi);
                                $('#ModalTambahPembayaran').modal('hide');
                                Swal.fire('Opps!', 'Terjadi Kesalahan Pada Saat Melakukan Pembayaran', 'error');
                                console.log(result);
                                $('#pay-button').html('<i class="bi bi-arrow-right-circle"></i> Lanjutkan');
                            },
                            onClose: function(){
                                /* You may add your own implementation here */
                                ShowPembayaran(GetKodeTransaksi);
                                Swal.fire('Pembayaran Dibatalkan!', 'Anda Telah Membatalkan Transaksi Ini', 'error');
                                $('#pay-button').html('<i class="bi bi-arrow-right-circle"></i> Lanjutkan');
                            }
                        })
                    });
