<?php
    ...
    if(empty($SessionIdAkses)){
        ...
        if(empty($_POST['kode_transaksi'])){
            ...
            $pengiriman=GetDetailData($Conn,'transaksi','kode_transaksi',$kode_transaksi,'pengiriman');
...
?>
                ...
                <?php
                    if($pengiriman=="Diambil"){
                        ...
                        echo '          <small class="credit mobile-text">';
                        echo '              <code class="text-dark">';
                        echo '                  Pelanggan memilih untuk mengambil barang pesanannya.';
                        echo '              </code>';
                        echo '          </small>';
                        echo '      </div>';
                        echo '  </div>';
                            ...
                            <small>
                                <?php 
                                    if(!empty($tujuan_pengiriman)){
                                        ...
                                        echo '  <li>Alamat 1 : <code class="text text-grayish">'.$alamt_pengiriman.'</code></li>';
                                        echo '  <li>Alamat 2 : <code class="text text-grayish">'.$rt_rw.'</code></li>';
                                        echo '  <li>Paket : <code class="text text-grayish">'.$cost_ongkir_item.'</code></li>';
                                        echo '</ul>';
                                    }else{
                                        echo '<code class="text text-danger">Tidak Ada</code>';
                                    }
