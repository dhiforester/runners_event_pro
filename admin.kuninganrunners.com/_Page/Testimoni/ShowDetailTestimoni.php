    ...
    if(empty($SessionIdAkses)){
        ...
        if(empty($_POST['id_web_testimoni'])){
            ...
            if(empty($id_web_testimoni_Valid)){
                ...
                //Apabila Foto testimoni Ada Dan Tidak ADa
                if(empty($foto_profil)){
                    $path_foto="assets/img/no_image.jpg";
                }else{
                    $path_foto=$foto_profil;
                }
                //Melakukan Format Pada Id Member
                $IdMemberFormat = substr($id_member, 0, 10). '...';
?>
        <div class="row">
            ...
            <div class="col-md-9 mb-3">
                <div class="row mb-3">
                    <div class="col col-md-4">
                        <small class="credit">ID Member</small>
                    </div>
                    <div class="col col-md-8">
                        <small class="credit">
                            <code class="text text-grayish">
                                <?php echo "$IdMemberFormat"; ?>
                            </code>
                        </small>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col col-md-4">
                        <small class="credit">Nik Name</small>
                    </div>
                    <div class="col col-md-8">
                        <small class="credit">
                            <code class="text text-grayish">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col col-md-8">
                        <small class="credit text-sm">
                            <code class="text text-grayish email-text">
                                <?php echo "$email"; ?>
                            </code>
                        </small>
                    </div>
