    ...
    if($ValidasiKelengkapanData!=="Valid"){
        ...
        if($ValidasiJumlahKarakter!=="Valid"){
            ...
            if($ValidasiTipeData!=="Valid"){
                ...
                $query = "UPDATE barang SET nama_barang = ?, kategori = ?, satuan = ?, harga = ?, stok = ?, dimensi = ?, deskripsi = ?, datetime = ?, updatetime = ? WHERE id_barang = ?";
                $stmt = $Conn->prepare($query);
                $stmt->bind_param("sssssssssi", $nama_barang, $kategori, $satuan, $harga, $stok, $dimensi, $deskripsi, $datetime, $updatetime, $id_barang);
                ...
                if ($stmt->execute()) {
                    ...
                    if($InputLog=="Success"){
                        ...
                        $response['message'] = 'Update Merchandise Berhasil';
                    }else{
