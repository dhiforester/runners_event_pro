<?php
    ...
    if(empty($SessionIdAkses)){
        ...
        if(empty($_POST['id_event'])){
            $errors[] = 'ID Event tidak boleh kosong!.';
        }else{
            //Validasi form_name tidak boleh kosong
            if(empty($_POST['form_name'])){
                $errors[] = 'Nama Form tidak boleh kosong!.';
            }else{
                //Validasi form_type tidak boleh kosong
                if(empty($_POST['form_type'])){
                    $errors[] = 'Tipe Form tidak boleh kosong!.';
                }else{
                    ...
                    if(empty($_POST['mandatori'])){
                        ...
                        if($ValidasiAlternatif!=="Valid"){
                            ...
                            //Buat ID
                            $id_event_assesment_form=GenerateToken(36);
                            // Insert data ke database
                            $query = "INSERT INTO event_assesment_form (
                            ...
                            if ($stmt->execute()) {
                                $kategori_log="Event";
                                $deskripsi_log="Tambah Assesment Form Event";
                                ...
                                $errors[] = 'Terjadi kesalahan pada saat insert data pada database!'.$Alternatif.'.';
                            }
                        }
                    }
                }
