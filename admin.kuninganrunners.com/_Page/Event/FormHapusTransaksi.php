...
?>
        ...
        <div class="row mb-3">
            <div class="col col-md-4"><small class="credit">ID Member</small></div>
        ...
        <div class="row mb-3">
            <div class="col col-md-12">
                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                    <small class="credit">
                        Dengan menghapus data transaksi ini akan menghapus semua record pembayaran yang sudah terhubung.<br>
                        <b>Apakah anda yakin akan melanjutkan untuk menghapus data ini?</b>
                    </small>
                </div>
            </div>
        </div>
