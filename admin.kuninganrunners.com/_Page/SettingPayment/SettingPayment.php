<?php
    ...
    if($IjinAksesSaya!=="Ada"){
        ...
        $api_payment_url=GetDetailData($Conn,'setting_payment','aktif_payment_gateway','Ya','api_payment_url');
        $id_marchant=GetDetailData($Conn,'setting_payment','aktif_payment_gateway','Ya','api_payment_url');
        $client_key=GetDetailData($Conn,'setting_payment','aktif_payment_gateway','Ya','api_payment_url');
        $server_key=GetDetailData($Conn,'setting_payment','aktif_payment_gateway','Ya','api_payment_url');
        $snap_url=GetDetailData($Conn,'setting_payment','aktif_payment_gateway','Ya','api_payment_url');
        $production=GetDetailData($Conn,'setting_payment','aktif_payment_gateway','Ya','api_payment_url');
        $aktif_payment_gateway=GetDetailData($Conn,'setting_payment','aktif_payment_gateway','Ya','api_payment_url');
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <?php
                    ...
                    echo '  Berikut ini adalah halaman pengaturan payment gateway khusus untuk pengguna provider <b>MIDTRANS</b>.';
                    echo '  Pada halaman ini anda bisa mengatur parameter payment gateway yang dibutuhkan.<br>';
