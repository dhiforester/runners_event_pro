<?php
    ...
    if(empty($_GET['id'])){
        echo '<b>ID Tidak Boleh Kosong!</b>';
    }else{
        $id=$_GET['id'];
        //Bersihkan Variabel
        $id_event_peserta=validateAndSanitizeInput($id);
        //Buka Data Peserta
        ...
        if(empty($id_event_peserta_validasi)){
            ...
            $nama_peserta=GetDetailData($Conn,'event_peserta','id_event_peserta',$id_event_peserta,'nama');
            ...
            $text_on_qr="$base_url/Sertifikat.php?id=$id_event_peserta";
