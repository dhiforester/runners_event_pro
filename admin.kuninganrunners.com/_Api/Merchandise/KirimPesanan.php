                                                        ...
                                                        if(!empty($validasi_member_keranjang)){
                                                            ...
                                                            if ($stmt->execute()) {
                                                                ...
                                                                if($validasi_proses_keranjang!==count($list_keranjang)){
                                                                    ...
                                                                    $id_wilayah_tujuan=$pengiriman['id_wilayah'];
                                                                    $rt_rw_tujuan=$pengiriman['rt_rw'];
                                                                    $kode_pos_tujuan=$pengiriman['kode_pos'];
                                                                    $nama_tujuan=$pengiriman['nama'];
                                                                    $kontak_tujuan=$pengiriman['kontak'];
                                                                    $provinsi_tujuen=GetDetailData($Conn,'wilayah','id_wilayah',$id_wilayah_tujuan,'propinsi');
                                                                    $kabupaten_tujuen=GetDetailData($Conn,'wilayah','id_wilayah',$id_wilayah_tujuan,'kabupaten');
                                                                    $kecamatan_tujuen=GetDetailData($Conn,'wilayah','id_wilayah',$id_wilayah_tujuan,'kecamatan');
                                                                    $desa_tujuen=GetDetailData($Conn,'wilayah','id_wilayah',$id_wilayah_tujuan,'desa');
                                                                    $tujuan_pengiriman = [
                                                                        "nama" => $nama_tujuan,
                                                                        "provinsi" => $provinsi_tujuen,
                                                                        "kabupaten" => $kabupaten_tujuen,
                                                                        "kecamatan" => $kecamatan_tujuen,
                                                                        "desa" => $desa_tujuen,
                                                                        "rt_rw" => $rt_rw_tujuan,
                                                                        "kode_pos" => $kode_pos_tujuan,
                                                                        "kontak" => $kontak_tujuan,
                                                                    ];
