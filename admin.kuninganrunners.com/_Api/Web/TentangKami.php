            ...
            if (!isset($headers['x-token'])) {
                ...
                if ($DataValidasiToken) {
                    ...
                    if ($now >= $datetime_creat && $now <= $datetime_expired) {
                        ...
                        $judul = GetDetailData($Conn, 'web_tentang', 'id_web_tentang', '1', 'judul');
                        $tentang = GetDetailData($Conn, 'web_tentang', 'id_web_tentang', '1', 'tentang');

                        // Mengonversi HTML konten menjadi aman untuk JSON
                        $tentang = htmlspecialchars($tentang, ENT_QUOTES, 'UTF-8');
