<?php
    ...
    $service_name = "Wilayah Kecamatan";
            ...
            if (!isset($headers['x-token'])) {
                ...
                if ($DataValidasiToken) {
                    ...
                    if ($now >= $datetime_creat && $now <= $datetime_expired) {
                        ...
                        if(!empty($_GET['id_kabupaten'])){
                            $id_kabupaten=$_GET['id_kabupaten'];
                            //Cari Nama Kabupaten
                            $kabupaten=GetDetailWilayah($Conn, 'wilayah', 'Kabupaten', $id_kabupaten);
                            if(!empty($kabupaten)){
                                $kategori="Kecamatan";
                                ...
                                while ($DataWilayah = $ResultWilayah->fetch_assoc()) {
                                    // Add to array
                                    $metadata[] = [
                                        "id_kecamatan" => $DataWilayah['id_wilayah'] ?? null,
                                        "kecamatan" => $DataWilayah['kecamatan'] ?? null
                                    ];
                                }
                                ...
                                $keterangan = "Kode Kabupaten Tidak Valid";
                            }
                        }else{
                            $keterangan = "Parameter ID Kabupaten Tidak Boleh Kosong";
                        }
                    } else {
