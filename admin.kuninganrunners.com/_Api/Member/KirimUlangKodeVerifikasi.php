<?php
    ...
    $service_name = "Kirim Ulang Kode Verifikasi";
                    ...
                    if ($DataValidasiToken) {
                        ...
                        if ($now >= $datetime_creat && $now <= $datetime_expired) {
                            ...
                            if(empty($id_member)){
                                ...
                                //Apakah Status Member Memang Belum Active?
                                $status = GetDetailData($Conn, 'member', 'email', $email, 'status');
                                if($status!=="Pending"){
                                    $keterangan= 'Akun Member Untuk Email Tersebut Sudah Active Dan Anda Tidak Perlu Melakukan Verifikasi Lagi'; 
                                }else{
                                    $email_validation = GetDetailData($Conn, 'member', 'email', $email, 'email_validation');
