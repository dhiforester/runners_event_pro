<?php
    ...
    if(empty($xtoken)){
        ...
        if(empty($_POST['penilaian'])){
            $ValidasiKelengkapanData="Form Penilaian tidak boleh kosong";
        }else{
            if(empty($_POST['testimoni'])){
                $ValidasiKelengkapanData="Setidaknya anda harus mengisi kotak saran dan kritik";
            }else{
        ...
        if($ValidasiKelengkapanData!=="Valid"){
            ...
            if($ValidasiSessionMember!=="Valid"){
                ...
                curl_setopt_array($curl, array(
                    CURLOPT_URL => $url_server . '/_Api/Testimoni/KirimTestimoni.php',
