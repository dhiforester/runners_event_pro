<?php
    ...
    if(empty($xtoken)){
        ...
        if (empty($_POST['id_event_peserta'])) {
            $ValidasiKelengkapanData="Kode Pendaftaran tidak boleh kosong! Anda wajib mengisi form tersebut.";
        }else{
                ...
                if($ValidasiTipeData!=="Valid"){
                    ...
                    if($ValidasiSessionMember!=="Valid"){
                        ...
                        curl_setopt_array($curl, array(
                            CURLOPT_URL => $url_server . '/_Api/Event/PembatalanPendaftaran.php',
